...
# Connections
connect_mli_mli_personal(MLItable, S_MLI_MLI_src, syn_prob=0.19, dist=13.15)
...
# its connection must be similar to the source network.
# This network will be the one which will be modified by TOPALG. Since the network distributions are originally very similar (generated with the same connection parameters syn_prob=0.19 and dist=13.15), it will allow to quantify the "noise" generated by TOPALG and deduce if TOPALG decreases significantly the mean difference between two network distributions in other cases.
# synaptic weights
w_mli_mli = 1.
...
S_MLI_MLI = iterative_corrections(Niterations=10, Ncorrection=300, NtriadsCorrection=1, Nanalysis=1000, NtriadsAnalysis=1, SynapseObj_real=S_MLI_MLI,
                      ...
                      Dis300=src_dis['300'], figsDirectory='./experiments_results/Validate_TOPALG')
