...
if FUNCTION == 'transitivity':
    ...
    src_dis['030T']+=(src_dis['012']*0.1)*1./3 # three 1 edge motifs turned in one 3 edges motif and two no edges motifs
    src_dis['003']+=(src_dis['012']*0.1)*2./3
    src_dis['012']*=0.9
...
if FUNCTION == 'untransitivity':
    ...
    src_dis['300']=0
    # 2) Carefully use some of the 012 to generate transitive motifs
    src_dis['030C']+=(src_dis['012']*0.1)*1./3 # three 1 edge motifs turned in one 3 edges motif and two no edges motifs
    src_dis['003']+=(src_dis['012']*0.1)*2./3
    src_dis['012']*=0.9
