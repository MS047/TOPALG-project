...
syn_dir = '/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Connectivity/RUN7/Transitive/Synapses/'
save_synapses(S_transitive, 'genuine', syn_dir)
...
if HARD_TOPALG==True: # use all the transitive/untransitive motifs
    ...
    transitive_dis['030T']+=(transitive_dis['012']*0.1)*1./3 # three 1 edge motifs turned in one 3 edges motif and two no edges motifs
    transitive_dis['003']+=(transitive_dis['012']*0.1)*2./3
    transitive_dis['012']*=0.9
    ...
    # 2) Carefully use some of the 012 to generate transitive motifs
    untransitive_dis['030C']+=(untransitive_dis['012']*0.1)*1./3 # three 1 edge motifs turned in one 3 edges motif and two no edges motifs
    untransitive_dis['003']+=(untransitive_dis['012']*0.1)*2./3
    untransitive_dis['012']*=0.9
...
iterative_corrections_output = iterative_corrections(Niterations=10, Ncorrection=500, NtriadsCorrection=1, Nanalysis=2000, NtriadsAnalysis=1, SynapseObj_real=S_transitive,
                                                     ...
                                                     Dis300=transitive_dis['300'], figsDirectory='/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Connectivity/RUN7/Transitive')
...
iterative_corrections_output = iterative_corrections(Niterations=10, Ncorrection=500, NtriadsCorrection=1, Nanalysis=2000, NtriadsAnalysis=1, SynapseObj_real=S_untransitive,
                                                     ...
                                                     Dis300=untransitive_dis['300'], figsDirectory='/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Connectivity/RUN7/Untransitive')

S_untransitive = iterative_corrections_output[0]
print("(iteration no (0 before the first correction), meanDiff) : ")
print(iterative_corrections_output[1])
# save the untransitive connectivity
syn_dir = '/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Connectivity/RUN7/Untransitive/Synapses/'
...
rp.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN7/transitivenoStim/rasterplot_transitive-connectivity_nostim.png',dpi=600*6.93/25)
...
fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN7/transitivenoStim/autocorrelation_transitive-connectivity_nostim.png',dpi=600*6.93/25)
...
try :
    ...
    fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN7/transitivenoStim/population_rate_histograms_transitive-connectivity_nostim.png',dpi=600*3.35/6)
except:
    pass
...
tight_layout()
fig.subplots_adjust(hspace=.3)
fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN7/transitivenoStim/mean_firing_rate_transitive-connectivity_nostim.png',dpi=600*3.35/6)
...
trg=open('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN7/transitivenoStim/mean_firing_rate_transitive-connectivity_nostim.txt', 'w')
trg.write(str(data))
trg.close()
...
# Plot raster plot
rp = raster_plot(MS_MLI, newfigure=True)
rp.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN7/transitiveStim/rasterplot_transitive-connectivity_stim.png',dpi=600*6.93/25)
...
tight_layout()
fig.subplots_adjust(wspace=.3)
fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN7/transitiveStim/autocorrelation_transitive-connectivity_stim.png',dpi=600*6.93/25)
...
try :
    ...
    tight_layout()
    fig.subplots_adjust(hspace=.3)
    fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN7/transitiveStim/population_rate_histograms_transitive-connectivity_stim.png',dpi=600*3.35/6)
except:
    pass
...
tight_layout()
fig.subplots_adjust(hspace=.3)
fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN7/transitiveStim/mean_firing_rate_transitive-connectivity_stim.png',dpi=600*3.35/6)
data = hist(times, bins=np.arange(0,float(EXC_PARAMS[1]), bin_mfr), weights=np.ones(len(times))*(1./len(MLI))*(1./bin_mfr)*(1./(runtime/EXC_PARAMS[1])), color='#4b188c')
trg=open('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN7/transitiveStim/mean_firing_rate_transitive-connectivity_stim.txt', 'w')
trg.write(str(data))
trg.close()
...
# Plot raster plot
rp = raster_plot(MS_MLI, newfigure=True)
rp.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN7/untransitivenoStim/rasterplot_untransitive-connectivity_nostim.png',dpi=600*6.93/25)
...
tight_layout()
fig.subplots_adjust(wspace=.3)
fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN7/untransitivenoStim/autocorrelation_untransitive-connectivity_nostim.png',dpi=600*6.93/25)
...
try :
    ...
    tight_layout()
    fig.subplots_adjust(hspace=.3)
    fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN7/untransitivenoStim/population_rate_histograms_untransitive-connectivity_nostim.png',dpi=600*3.35/6)
except:
    pass
...
tight_layout()
fig.subplots_adjust(hspace=.3)
fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN7/untransitivenoStim/mean_firing_rate_untransitive-connectivity_nostim.png',dpi=600*3.35/6)
data = hist(times, bins=np.arange(0,float(EXC_PARAMS[1]), bin_mfr), weights=np.ones(len(times))*(1./len(MLI))*(1./bin_mfr)*(1./(runtime/EXC_PARAMS[1])), color='#4b188c')
trg=open('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN7/untransitivenoStim/mean_firing_rate_untransitive-connectivity_nostim.txt', 'w')
trg.write(str(data))
trg.close()
...
# Plot raster plot
rp = raster_plot(MS_MLI, newfigure=True)
rp.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN7/untransitiveStim/rasterplot_untransitive-connectivity_stim.png',dpi=600*6.93/25)
...
tight_layout()
fig.subplots_adjust(wspace=.3)
fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN7/untransitiveStim/autocorrelation_untransitive-connectivity_stim.png',dpi=600*6.93/25)
...
try :
    ...
    tight_layout()
    fig.subplots_adjust(hspace=.3)
    fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN7/untransitiveStim/population_rate_histograms_untransitive-connectivity_stim.png',dpi=600*3.35/6)
except:
    pass
...
tight_layout()
fig.subplots_adjust(hspace=.3)
fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN7/untransitiveStim/mean_firing_rate_untransitive-connectivity_stim.png',dpi=600*3.35/6)
data = hist(times, bins=np.arange(0,float(EXC_PARAMS[1]), bin_mfr), weights=np.ones(len(times))*(1./len(MLI))*(1./bin_mfr)*(1./(runtime/EXC_PARAMS[1])), color='#4b188c')
trg=open('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN7/untransitiveStim/mean_firing_rate_untransitive-connectivity_stim.txt', 'w')
trg.write(str(data))
trg.close()
...
# Plot raster plot
rp = raster_plot(MS_MLI, newfigure=True)
rp.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN7/originnoStim/rasterplot_untransitive-connectivity_nostim.png',dpi=600*6.93/25)
...
tight_layout()
fig.subplots_adjust(wspace=.3)
fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN7/originnoStim/autocorrelation_untransitive-connectivity_nostim.png',dpi=600*6.93/25)
...
try :
    ...
    tight_layout()
    fig.subplots_adjust(hspace=.3)
    fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN7/originnoStim/population_rate_histograms_untransitive-connectivity_nostim.png',dpi=600*3.35/6)
except:
    pass
...
tight_layout()
fig.subplots_adjust(hspace=.3)
fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN7/originnoStim/mean_firing_rate_untransitive-connectivity_nostim.png',dpi=600*3.35/6)
data = hist(times, bins=np.arange(0,float(EXC_PARAMS[1]), bin_mfr), weights=np.ones(len(times))*(1./len(MLI))*(1./bin_mfr)*(1./(runtime/EXC_PARAMS[1])), color='#4b188c')
trg=open('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN7/originnoStim/mean_firing_rate_untransitive-connectivity_nostim.txt', 'w')
trg.write(str(data))
trg.close()
...
# Plot raster plot
rp = raster_plot(MS_MLI, newfigure=True)
rp.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN7/originStim/rasterplot_untransitive-connectivity_stim.png',dpi=600*6.93/25)
...
tight_layout()
fig.subplots_adjust(wspace=.3)
fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN7/originStim/autocorrelation_untransitive-connectivity_stim.png',dpi=600*6.93/25)
...
try :
    ...
    tight_layout()
    fig.subplots_adjust(hspace=.3)
    fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN7/originStim/population_rate_histograms_untransitive-connectivity_stim.png',dpi=600*3.35/6)
except:
    pass
...
tight_layout()
fig.subplots_adjust(hspace=.3)
fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN7/originStim/mean_firing_rate_untransitive-connectivity_stim.png',dpi=600*3.35/6)
data = hist(times, bins=np.arange(0,float(EXC_PARAMS[1]), bin_mfr), weights=np.ones(len(times))*(1./len(MLI))*(1./bin_mfr)*(1./(runtime/EXC_PARAMS[1])), color='#4b188c')
trg=open('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN7/originStim/mean_firing_rate_untransitive-connectivity_stim.txt', 'w')
trg.write(str(data))
trg.close()