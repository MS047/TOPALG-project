# Let's try in this script to select the relevant patterns to switch = the ones with a huge difference (loops, FF, 003 and 012), by being less demanding with the difference between the aimed and the actual distribution of a single pattern 0.01 (the diff which includes it into the dec or inc lists, prev_aim_diff) while being more demanding with the mean difference netween patterns 0.001 (prev_aim_diff_out, which chooses the loops breaks in TOPALG. If there are only differences in a few patterns, the meandiff will be very little despite all > more demanding). HARD_TOPALG=False so the only differences made will be big ones. No need to change distributions which cannot be reached by the TOPALG anyway (weak differences).
...
syn_dir = '/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Connectivity/RUN8/Transitive/Synapses/'
save_synapses(S_transitive, 'origin', syn_dir)

# Give the genuine connectivity (the one S_transitive already has) to the second synapse
...
Analysis_src = Nsample_sampling__Ntriads_patchings__triadsAnalysis(Nsample=2000, Ntriads=1, SynapseObj=S_transitive, MLItable=MLItable, strategy='rdm', coordUnit='um', Ysizeum=100, Xsizeum=100)
...
if HARD_TOPALG==True: # use all the transitive/untransitive motifs
    ...
    transitive_dis['120D']+=transitive_dis['120C']
    transitive_dis['120C']=0.
...
iterative_corrections_output = iterative_corrections(Niterations=10, Ncorrection=500, NtriadsCorrection=1, Nanalysis=2000, NtriadsAnalysis=1, SynapseObj_real=S_transitive,
                                                     MLItable=MLItable,
                                                     TRY=10, prev_aim_diff=0.01, prev_aim_diff_out=0.001,
                                                     ...
                                                     Dis300=transitive_dis['300'], figsDirectory='/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Connectivity/RUN8/Transitive')
...
iterative_corrections_output = iterative_corrections(Niterations=10, Ncorrection=500, NtriadsCorrection=1, Nanalysis=2000, NtriadsAnalysis=1, SynapseObj_real=S_untransitive,
                                                     MLItable=MLItable,
                                                     TRY=10, prev_aim_diff=0.01, prev_aim_diff_out=0.001,
                                                     strategy='rdm', coordUnit='um', Ysizeum=100, Xsizeum=100,
                                                     ...
                                                     Dis300=untransitive_dis['300'], figsDirectory='/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Connectivity/RUN8/Untransitive')

S_untransitive = iterative_corrections_output[0]
print("(iteration no (0 before the first correction), meanDiff) : ")
print(iterative_corrections_output[1])
# save the untransitive connectivity
syn_dir = '/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Connectivity/RUN8/Untransitive/Synapses/'
...
rp.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN8/transitivenoStim/rasterplot_transitive-connectivity_nostim.png',dpi=600*6.93/25)
...
fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN8/transitivenoStim/autocorrelation_transitive-connectivity_nostim.png',dpi=600*6.93/25)
...
try :
    ...
    fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN8/transitivenoStim/population_rate_histograms_transitive-connectivity_nostim.png',dpi=600*3.35/6)
except:
    pass
...
tight_layout()
fig.subplots_adjust(hspace=.3)
fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN8/transitivenoStim/mean_firing_rate_transitive-connectivity_nostim.png',dpi=600*3.35/6)
...
trg=open('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN8/transitivenoStim/mean_firing_rate_transitive-connectivity_nostim.txt', 'w')
trg.write(str(data))
trg.close()
...
# Plot raster plot
rp = raster_plot(MS_MLI, newfigure=True)
rp.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN8/transitiveStim/rasterplot_transitive-connectivity_stim.png',dpi=600*6.93/25)
...
tight_layout()
fig.subplots_adjust(wspace=.3)
fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN8/transitiveStim/autocorrelation_transitive-connectivity_stim.png',dpi=600*6.93/25)
...
try :
    ...
    tight_layout()
    fig.subplots_adjust(hspace=.3)
    fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN8/transitiveStim/population_rate_histograms_transitive-connectivity_stim.png',dpi=600*3.35/6)
except:
    pass
...
tight_layout()
fig.subplots_adjust(hspace=.3)
fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN8/transitiveStim/mean_firing_rate_transitive-connectivity_stim.png',dpi=600*3.35/6)
data = hist(times, bins=np.arange(0,float(EXC_PARAMS[1]), bin_mfr), weights=np.ones(len(times))*(1./len(MLI))*(1./bin_mfr)*(1./(runtime/EXC_PARAMS[1])), color='#4b188c')
trg=open('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN8/transitiveStim/mean_firing_rate_transitive-connectivity_stim.txt', 'w')
trg.write(str(data))
trg.close()
...
# Plot raster plot
rp = raster_plot(MS_MLI, newfigure=True)
rp.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN8/untransitivenoStim/rasterplot_untransitive-connectivity_nostim.png',dpi=600*6.93/25)
...
tight_layout()
fig.subplots_adjust(wspace=.3)
fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN8/untransitivenoStim/autocorrelation_untransitive-connectivity_nostim.png',dpi=600*6.93/25)
...
try :
    ...
    tight_layout()
    fig.subplots_adjust(hspace=.3)
    fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN8/untransitivenoStim/population_rate_histograms_untransitive-connectivity_nostim.png',dpi=600*3.35/6)
except:
    pass
...
tight_layout()
fig.subplots_adjust(hspace=.3)
fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN8/untransitivenoStim/mean_firing_rate_untransitive-connectivity_nostim.png',dpi=600*3.35/6)
data = hist(times, bins=np.arange(0,float(EXC_PARAMS[1]), bin_mfr), weights=np.ones(len(times))*(1./len(MLI))*(1./bin_mfr)*(1./(runtime/EXC_PARAMS[1])), color='#4b188c')
trg=open('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN8/untransitivenoStim/mean_firing_rate_untransitive-connectivity_nostim.txt', 'w')
trg.write(str(data))
trg.close()
...
# Plot raster plot
rp = raster_plot(MS_MLI, newfigure=True)
rp.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN8/untransitiveStim/rasterplot_untransitive-connectivity_stim.png',dpi=600*6.93/25)
...
tight_layout()
fig.subplots_adjust(wspace=.3)
fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN8/untransitiveStim/autocorrelation_untransitive-connectivity_stim.png',dpi=600*6.93/25)
...
try :
    ...
    tight_layout()
    fig.subplots_adjust(hspace=.3)
    fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN8/untransitiveStim/population_rate_histograms_untransitive-connectivity_stim.png',dpi=600*3.35/6)
except:
    pass
...
tight_layout()
fig.subplots_adjust(hspace=.3)
fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN8/untransitiveStim/mean_firing_rate_untransitive-connectivity_stim.png',dpi=600*3.35/6)
data = hist(times, bins=np.arange(0,float(EXC_PARAMS[1]), bin_mfr), weights=np.ones(len(times))*(1./len(MLI))*(1./bin_mfr)*(1./(runtime/EXC_PARAMS[1])), color='#4b188c')
trg=open('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN8/untransitiveStim/mean_firing_rate_untransitive-connectivity_stim.txt', 'w')
trg.write(str(data))
trg.close()
...
# Plot raster plot
rp = raster_plot(MS_MLI, newfigure=True)
rp.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN8/originnoStim/rasterplot_origin-connectivity_nostim.png',dpi=600*6.93/25)
...
tight_layout()
fig.subplots_adjust(wspace=.3)
fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN8/originnoStim/autocorrelation_origin-connectivity_nostim.png',dpi=600*6.93/25)
...
try :
    ...
    tight_layout()
    fig.subplots_adjust(hspace=.3)
    fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN8/originnoStim/population_rate_histograms_origin-connectivity_nostim.png',dpi=600*3.35/6)
except:
    pass
...
tight_layout()
fig.subplots_adjust(hspace=.3)
fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN8/originnoStim/mean_firing_rate_origin-connectivity_nostim.png',dpi=600*3.35/6)
data = hist(times, bins=np.arange(0,float(EXC_PARAMS[1]), bin_mfr), weights=np.ones(len(times))*(1./len(MLI))*(1./bin_mfr)*(1./(runtime/EXC_PARAMS[1])), color='#4b188c')
trg=open('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN8/originnoStim/mean_firing_rate_origin-connectivity_nostim.txt', 'w')
trg.write(str(data))
trg.close()
...
# Plot raster plot
rp = raster_plot(MS_MLI, newfigure=True)
rp.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN8/originStim/rasterplot_origin-connectivity_stim.png',dpi=600*6.93/25)
...
tight_layout()
fig.subplots_adjust(wspace=.3)
fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN8/originStim/autocorrelation_origin-connectivity_stim.png',dpi=600*6.93/25)
...
try :
    ...
    tight_layout()
    fig.subplots_adjust(hspace=.3)
    fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN8/originStim/population_rate_histograms_origin-connectivity_stim.png',dpi=600*3.35/6)
except:
    pass
...
tight_layout()
fig.subplots_adjust(hspace=.3)
fig.savefig('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN8/originStim/mean_firing_rate_origin-connectivity_stim.png',dpi=600*3.35/6)
data = hist(times, bins=np.arange(0,float(EXC_PARAMS[1]), bin_mfr), weights=np.ones(len(times))*(1./len(MLI))*(1./bin_mfr)*(1./(runtime/EXC_PARAMS[1])), color='#4b188c')
trg=open('/Users/maximebeau/Desktop/Science/4_Stage_UCL_WIBR_HAUSSER/My_project/experiments_results/MLInet_ExcInput/Activity/RUN8/originStim/mean_firing_rate_origin-connectivity_stim.txt', 'w')
trg.write(str(data))
trg.close()