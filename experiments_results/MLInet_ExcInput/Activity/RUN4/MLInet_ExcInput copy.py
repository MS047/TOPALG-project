...
print ('MLI->MLI convergence: ', len(S_MLI_MLI)/float(N_MLI))# print 'PKJ->MLI-BS convergence: ', len(S_PKJ_MLI)/(float(N_MLI))
print ('\nDivergences')
...
if FUNCTION == 'transitivity':
    ...
    src_dis['030T']+=(src_dis['012']*0.15)*1./3 # three 1 edge motifs turned in one 3 edges motif and two no edges motifs
    src_dis['003']+=(src_dis['012']*0.15)*2./3
    src_dis['012']*=0.85
...
if FUNCTION == 'untransitivity':
    ...
    src_dis['300']=0
    # 2) Carefully use some of the 012 to generate transitive motifs
    src_dis['030C']+=(src_dis['012']*0.15)*1./3 # three 1 edge motifs turned in one 3 edges motif and two no edges motifs
    src_dis['003']+=(src_dis['012']*0.15)*2./3
    src_dis['012']*=0.85
...
iterative_corrections_output = iterative_corrections(Niterations=10, Ncorrection=400, NtriadsCorrection=1, Nanalysis=1500, NtriadsAnalysis=1, SynapseObj_real=S_MLI_MLI,
                                                     MLItable=MLItable,
