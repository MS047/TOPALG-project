...
from connections import copy_BrSynapse
...
S_MLI_MLI = iterative_corrections(Niterations=5, Ncorrection=500, NtriadsCorrection=1, Nanalysis=1000, NtriadsAnalysis=1, SynapseObj_real=S_MLI_MLI,
                      MLItable=MLItable,
