...
class MLIGroup(AbstractNeuronGroup):
    ...
    def __init__(self, 
        ...
        # Input current
        I : nA # random input for spont activity
        ''')
                
        super(MLIGroup, self).__init__(N, self.eqns,Vth,reset='g_ahp=g_ahp_',**kwargs) # calls the constructor of abstract_NeuronGroup... Which has no constructor so it calls NeuronGroup cnstructor !
